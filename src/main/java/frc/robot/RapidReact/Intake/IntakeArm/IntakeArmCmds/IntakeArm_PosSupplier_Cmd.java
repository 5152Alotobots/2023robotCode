...
public class IntakeArm_PosSupplier_Cmd extends CommandBase {
  /** Creates a new Intake_Lift_SpdCmd. */

  public final IntakeArmSubSys m_IntakeArmSubSys;
  public final DoubleSupplier m_IntakeArmPosCmd;

  public IntakeArm_PosSupplier_Cmd(
    IntakeArmSubSys intakeArmSubSys,
    DoubleSupplier intakeArmPosCmd){
  ...
  public void initialize() {
    m_IntakeArmSubSys.setIntakeArmPos(m_IntakeArmPosCmd.getAsDouble());
