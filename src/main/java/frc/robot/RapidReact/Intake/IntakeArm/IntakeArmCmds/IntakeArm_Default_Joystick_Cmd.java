...
public class IntakeArm_Default_Joystick_Cmd extends CommandBase {
 ...
 // public final BooleanSupplier m_IntakeArm_Down;
  public final DoubleSupplier m_IntakeArm_Axis;

  public IntakeArm_Default_Joystick_Cmd(
    IntakeArmSubSys intakeArmSubSys,
    //BooleanSupplier intakeArmUp,
    //BooleanSupplier intakeArmDown)
    DoubleSupplier intakeArmAxis){
    // Use addRequirements() here to declare subsystem dependencies.
    m_IntakeArmSubSys = intakeArmSubSys;
    //m_IntakeArm_Up = intakeArmUp;
    //m_IntakeArm_Down = intakeArmDown;
    m_IntakeArm_Axis = intakeArmAxis;
  ...
  @Override
  public void execute() {
    m_IntakeArmSubSys.setIntakeArmSpd(m_IntakeArm_Axis.getAsDouble()*.5, false);
    }
